...
export default function MyTeamsScreen({ navigation }) {
  ...
  // 我的问题列表（用于创建团队时选择）
  const myQuestions = [
    { id: 1, title: '如何在三个月内从零基础学会Python编程？', type: 'reward', reward: 50 },
    { id: 2, title: '第一次养猫需要准备什么？', type: 'free' },
    { id: 3, title: '35岁程序员如何规划职业发展？', type: 'reward', reward: 100 },
  ];
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  statsCard: { flexDirection: 'row', backgroundColor: '#fff', marginHorizontal: 16, marginTop: 16, borderRadius: 12, padding: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2 },
  ...
  teamsSection: { marginTop: 16, paddingHorizontal: 16 },
  sectionTitle: { fontSize: 15, fontWeight: '600', color: '#374151', marginBottom: 12 },
  teamCard: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 12, padding: 12, marginBottom: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2 },
  teamAvatar: { width: 56, height: 56, borderRadius: 12, backgroundColor: '#f3f4f6' },
  teamInfo: { flex: 1, marginLeft: 12 },
  teamHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
  teamName: { fontSize: 15, fontWeight: '600', color: '#1f2937', flex: 1 },
  roleTag: { backgroundColor: '#f3f4f6', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  roleTagLeader: { backgroundColor: '#fef2f2', borderWidth: 1, borderColor: '#fecaca' },
  roleText: { fontSize: 11, color: '#6b7280', fontWeight: '500' },
  roleTextLeader: { color: '#ef4444' },
  teamDesc: { fontSize: 13, color: '#6b7280', lineHeight: 18, marginBottom: 8 },
  teamMeta: { flexDirection: 'row', gap: 12 },
