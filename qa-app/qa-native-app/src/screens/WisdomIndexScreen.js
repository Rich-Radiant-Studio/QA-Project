...
const styles = StyleSheet.create({
  ...
  indexLabel: { fontSize: 14, color: '#6b7280', marginBottom: 8 },
  indexValue: { fontSize: 48, fontWeight: 'bold', color: '#f59e0b', marginBottom: 16 },
  ...
  indexDesc: { fontSize: 13, color: '#9ca3af' },
  ...
  indicatorValue: { fontSize: 24, fontWeight: 'bold', color: '#1f2937', marginBottom: 4 },
  indicatorLabel: { fontSize: 12, color: '#6b7280', textAlign: 'center' },
  ...
  scoreValue: { fontSize: 36, fontWeight: 'bold', color: '#f59e0b', marginBottom: 12 },
  ...
  historyInfo: { flex: 1 },
  historyBankName: { fontSize: 14, fontWeight: '500', color: '#1f2937', marginBottom: 6 },
  ...
  historyScore: { fontSize: 18, fontWeight: 'bold', color: '#f59e0b', marginBottom: 2 },
