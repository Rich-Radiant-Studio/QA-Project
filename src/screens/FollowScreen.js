...
const followedQuestions = [
  { id: 1, author: 'Python老司机', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=follow1', verified: true, time: '30分钟前', type: 'reward', reward: 50, answerTypes: ['public'], title: '如何在三个月内从零基础学会Python编程？有没有系统的学习路线推荐？', likes: 256, comments: 23, solvedPercent: 65 },
  { id: 2, author: '王医生', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=follow2', verified: true, time: '1小时前', type: 'free', answerTypes: ['public'], title: '作为医生，如何平衡工作和生活？有没有同行分享一下经验？', likes: 89, comments: 12, solvedPercent: 25 },
  { id: 3, author: '美食达人', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=follow3', time: '2小时前', type: 'free', answerTypes: ['public'], title: '有什么简单又好吃的家常菜推荐？最好是新手也能做的那种', likes: 368, comments: 45, solvedPercent: 92 },
  { id: 4, author: '程序员小明', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=follow4', time: '3小时前', type: 'reward', reward: 100, answerTypes: ['public', 'targeted'], title: '35岁程序员如何规划职业发展？是继续技术深耕还是转管理？', likes: 1200, comments: 456, solvedPercent: 30 },
];
