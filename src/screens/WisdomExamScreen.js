...
const styles = StyleSheet.create({
  ...
  startTitle: { fontSize: 28, fontWeight: 'bold', color: '#1f2937', marginBottom: 8 },
  startDesc: { fontSize: 16, color: '#6b7280', marginBottom: 32 },
  rulesCard: { backgroundColor: '#fff', borderRadius: 16, padding: 20, width: '100%', marginBottom: 32 },
  rulesTitle: { fontSize: 18, fontWeight: '600', color: '#1f2937', marginBottom: 16 },
  ...
  startBtnText: { fontSize: 16, color: '#fff', fontWeight: '600', textAlign: 'center' },
  ...
  questionCount: { fontSize: 14, color: '#9ca3af' },
  questionText: { fontSize: 18, color: '#1f2937', lineHeight: 28 },
  ...
  answerSheetTitle: { fontSize: 16, fontWeight: '600', color: '#1f2937', marginBottom: 16 },
  ...
  answerSheetItemText: { fontSize: 14, color: '#6b7280', fontWeight: '500' },
  ...
  footerBtnText: { fontSize: 15, color: '#374151', fontWeight: '500' },
  ...
  resultTitle: { fontSize: 28, fontWeight: 'bold', color: '#1f2937', marginBottom: 16 },
  resultScore: { fontSize: 64, fontWeight: 'bold', color: '#f59e0b', marginBottom: 8 },
  resultRank: { fontSize: 20, color: '#6b7280', marginBottom: 32 },
  resultStats: { flexDirection: 'row', gap: 24, marginBottom: 32 },
  resultStatItem: { alignItems: 'center' },
  resultStatValue: { fontSize: 32, fontWeight: 'bold', color: '#1f2937', marginBottom: 4 },
  resultStatLabel: { fontSize: 14, color: '#9ca3af' },
  resultBtn: { backgroundColor: '#f59e0b', paddingVertical: 16, paddingHorizontal: 48, borderRadius: 12, width: '100%', marginBottom: 12 },
  resultBtnText: { fontSize: 16, color: '#fff', fontWeight: '600', textAlign: 'center' },
  ...
  resultSecondaryBtnText: { fontSize: 16, color: '#374151', fontWeight: '500', textAlign: 'center' },
  ...
  explanationTitle: { fontSize: 24, fontWeight: 'bold', color: '#1f2937', textAlign: 'center', marginBottom: 8 },
  explanationDesc: { fontSize: 15, color: '#6b7280', textAlign: 'center', marginBottom: 32 },
  explanationCard: { backgroundColor: '#fff', borderRadius: 16, padding: 20, marginBottom: 20, borderWidth: 1, borderColor: '#e5e7eb' },
  explanationCardTitle: { fontSize: 16, fontWeight: '600', color: '#1f2937', marginBottom: 16 },
  ...
  explanationLabel: { fontSize: 14, color: '#6b7280' },
  explanationValue: { fontSize: 15, color: '#1f2937', fontWeight: '500' },
  ...
  explanationNoticeTitle: { fontSize: 14, fontWeight: '600', color: '#92400e', marginBottom: 4 },
  explanationNoticeText: { fontSize: 13, color: '#92400e', lineHeight: 20 },
  explanationTips: { backgroundColor: '#f9fafb', borderRadius: 12, padding: 16, marginBottom: 24 },
  explanationTipsTitle: { fontSize: 14, fontWeight: '600', color: '#374151', marginBottom: 12 },
  explanationTipsText: { fontSize: 13, color: '#6b7280', lineHeight: 22, marginBottom: 4 },
