    ...
    <TouchableOpacity style={styles.rankingItem} onPress={onPress}>
      ...
      <View style={styles.incomeInfo}>
        <View style={styles.incomeRow}>
          ...
          {item.trend === 'same' && (
            <View style={[styles.trendBadge, styles.trendBadgeSame]}>
...
const styles = StyleSheet.create({
  ...
  list: { flex: 1 },
  listFooter: { paddingVertical: 30, alignItems: 'center' },
  footerText: { fontSize: 13, color: '#9ca3af' },
  
  rankingItem: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#f9fafb' },
  rankBadge: { width: 28, height: 28, borderRadius: 6, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  ...
  userTitle: { fontSize: 12, color: '#6b7280', marginBottom: 6 },
  statsRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  statItem: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  statText: { fontSize: 11, color: '#9ca3af' },
  
  incomeInfo: { alignItems: 'flex-end', marginLeft: 12 },
  incomeRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 },
  incomeAmount: { fontSize: 17, fontWeight: '700', color: '#ef4444' },
  trendBadge: { flexDirection: 'row', alignItems: 'center', gap: 2, backgroundColor: '#f0fdf4', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 10 },
  trendBadgeDown: { backgroundColor: '#fef2f2' },
  trendBadgeSame: { backgroundColor: '#f9fafb' },
  trendText: { fontSize: 10, color: '#22c55e', fontWeight: '600' },
  trendTextDown: { color: '#ef4444' },
  monthIncome: { fontSize: 11, color: '#9ca3af' },
});
